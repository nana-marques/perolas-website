    ...
    <main role="main">
        <div class="container mt-5">
            <div class="row jumbotron mt-5">
                <!-- <div class="container d-flex justify-content-center" style="background-color:#fed7da;"> -->
...
<script>
    ...
    function fillModalNome(nome) {
        ...
        document.getElementById("precobolo").textContent = array[5];
    }
