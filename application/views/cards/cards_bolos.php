    ...
    <main role="main">
        <div class="container mt-5">
            ...
            <div class="row mt-5">
                ...
                if(($this->input->post("bolos")) == "Chocolate"){ 
                    $this->load->model('Mbolos');
	
		            $select =  $this->input->post("bolos");
		            $resultado = $this->Mbolos->select($select);
                ...
                if(($this->input->post("bolos")) == "Bolo Branco"){
                ...
                if(($this->input->post("bolos")) == "Caseiro"){
                    $this->load->model('Mbolos');
                ...
                if(($this->input->post("bolos")) == "Todos" || !($this->input->post("bolos"))){
